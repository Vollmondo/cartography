...
var overlays = {
    ...
    Температура: new L.tileLayer('http://tile.openweathermap.org/map/temp_new/{z}/{x}/{y}.png?appid=7a9a513014a5a21770f346bac4ae92bf', 
        {maxZoom: 20,
    ...
    Осадки: L.tileLayer('http://tile.openweathermap.org/map/precipitation_new/{z}/{x}/{y}.png?appid=7a9a513014a5a21770f346bac4ae92bf', 
        {maxZoom: 20,
    ...
    Ветер: L.tileLayer('http://tile.openweathermap.org/map/wind_new/{z}/{x}/{y}.png?appid=7a9a513014a5a21770f346bac4ae92bf',
        {maxZoom: 20,
